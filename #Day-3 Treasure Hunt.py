...
if left_or_right == "left":
    swim_or_wait = input("You come to a lake. There is a an island in the middle of the lake. Type 'wait' to wait for a boat. Type 'swim' to swim across. ")
    ...
    else: print("you were attacked by trout. game over ")
